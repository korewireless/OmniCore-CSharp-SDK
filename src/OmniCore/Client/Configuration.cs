...
namespace OmniCore.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.8.10/csharp");
        ...
        public Configuration(
            ...
            string basePath = "https://api.korewireless.com") : this()
        {
        ...
        {
            string report = "C# SDK (OmniCore) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.8.10\n";
            report += "    SDK Package Version: 1.8.10\n";
