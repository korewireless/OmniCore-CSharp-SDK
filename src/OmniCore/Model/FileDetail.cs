...
namespace OmniCore.Model
{
    ...
    public partial class FileDetail : IEquatable<FileDetail>, IValidatableObject
    {
        ...
        public FileDetail(string name = default(string), string url = default(string))
        {
            this.Name = name;
            this.Url = url;
        }
        ...
        {
            return this.Equals(input as FileDetail);
        }

        /// <summary>
        /// Returns true if FileDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of FileDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileDetail input)
        {
            if (input == null)
            {
                return false;
