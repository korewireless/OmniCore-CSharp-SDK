...
namespace OmniCore.Model
{
    ...
    public partial class MetricsLogs : IEquatable<MetricsLogs>, IValidatableObject
    {
        ...
        public MetricsLogs(int noOfFiles = default(int), decimal fileSize = default(decimal), int noofoperations = default(int), string updatedon = default(string), int noOfReplays = default(int), int noOfExports = default(int))
        {
