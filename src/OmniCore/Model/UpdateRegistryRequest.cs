...
namespace OmniCore.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateRegistry_request")]
    public partial class UpdateRegistryRequest : IEquatable<UpdateRegistryRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRegistryRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateRegistryRequest);
        }

        /// <summary>
        /// Returns true if UpdateRegistryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateRegistryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateRegistryRequest input)
        {
            if (input == null)
            {
                return false;
