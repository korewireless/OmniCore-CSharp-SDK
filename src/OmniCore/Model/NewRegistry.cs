...
namespace OmniCore.Model
{
    ...
    /// NewRegistry
    /// </summary>
    [DataContract(Name = "NewRegistry")]
    public partial class NewRegistry : IEquatable<NewRegistry>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewRegistry" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewRegistry() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewRegistry" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NewRegistry);
        }

        /// <summary>
        /// Returns true if NewRegistry instances are equal
        /// </summary>
        /// <param name="input">Instance of NewRegistry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewRegistry input)
        {
            if (input == null)
            {
                return false;
