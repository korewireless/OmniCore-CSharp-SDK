...
namespace OmniCore.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createRegistry_request")]
    public partial class CreateRegistryRequest : IEquatable<CreateRegistryRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRegistryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateRegistryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRegistryRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CreateRegistryRequest);
        }

        /// <summary>
        /// Returns true if CreateRegistryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateRegistryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateRegistryRequest input)
        {
            if (input == null)
            {
                return false;
