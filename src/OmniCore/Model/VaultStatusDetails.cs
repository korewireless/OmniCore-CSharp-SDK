...
namespace OmniCore.Model
{
    ...
    public partial class VaultStatusDetails : IEquatable<VaultStatusDetails>, IValidatableObject
    {
        ...
        public VaultStatusDetails(string subscriptionId = default(string), string storageType = default(string), bool isEnabled = default(bool), bool isCreated = default(bool), string updatedon = default(string), string createdOn = default(string), string mqttId = default(string), int retentionPeriod = default(int), int encryptionKeyId = default(int), bool isEncrypted = default(bool))
        {
