...
namespace OmniCore.Model
{
    ...
    /// CustomOnboard
    /// </summary>
    [DataContract(Name = "CustomOnboard")]
    public partial class CustomOnboard : IEquatable<CustomOnboard>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomOnboard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomOnboard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomOnboard" /> class.
        /// </summary>
        ...
        /// <param name="customOnboardData">customOnboardData.</param>
        /// <param name="isApprove">isApprove.</param>
        public CustomOnboard(string id = default(string), bool blocked = default(bool), List<DeviceCredential> credentials = default(List<DeviceCredential>), List<string> gateway = default(List<string>), GatewayConfig gatewayConfig = default(GatewayConfig), bool isGateway = default(bool), ErrorStatus lastErrorStatus = default(ErrorStatus), LogLevel? logLevel = default(LogLevel?), Dictionary<string, string> metadata = default(Dictionary<string, string>), DeviceConfig config = default(DeviceConfig), DeviceState state = default(DeviceState), Policy policy = default(Policy), string customOnboardData = default(string), bool isApprove = default(bool))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CustomOnboard and cannot be null");
            }
            this.Id = id;
            ...
            this.State = state;
            this.Policy = policy;
            this.CustomOnboardData = customOnboardData;
        ...
        /// <summary>
        /// Gets or Sets CustomOnboardData
        /// </summary>
        [DataMember(Name = "customOnboardData", EmitDefaultValue = false)]
        public string CustomOnboardData { get; set; }

        /// <summary>
        /// Gets or Sets IsApprove
        /// </summary>
        [DataMember(Name = "isApprove", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CustomOnboardData: ").Append(CustomOnboardData).Append("\n");
        ...
        {
            return this.Equals(input as CustomOnboard);
        }

        /// <summary>
        /// Returns true if CustomOnboard instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomOnboard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomOnboard input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CustomOnboardData == input.CustomOnboardData ||
                    (this.CustomOnboardData != null &&
                    this.CustomOnboardData.Equals(input.CustomOnboardData))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CustomOnboardData != null)
                {
                    hashCode = (hashCode * 59) + this.CustomOnboardData.GetHashCode();
                }
