...
namespace OmniCore.Api
{
    ...
    public interface IDeviceApiSync : IApiAccessor
    {
        ...
        /// <param name="pageSize">The maximum number of devices to return in the response. If this value is zero, the service will select a default size.  (optional)</param>
        /// <param name="fieldMask">The fields of the Device resource to be returned to the response. The fields id and numId are always returned, along with any other fields specified. A comma-separated list of fully qualified names of fields. Example:  (optional)</param>
        /// <param name="sortByClientOnline">Set to true to return devices sorted by last heartbeat  (optional)</param>
        /// <param name="deviceIds">A list of device string IDs. For example, [&#39;device0&#39;, &#39;device12&#39;]. If empty, this field is ignored. Maximum IDs: 10,000 (optional)</param>
        /// <param name="deviceNumIds">A list of device numeric IDs. If empty, this field is ignored. Maximum IDs: 10,000. (optional)</param>
        /// <param name="gatewayListOptionsAssociationsDeviceId">If set, returns only the gateways with which the specified device is associated. The device ID can be numeric (num_id) or the user-defined string (id). For example, if 456 is specified, returns only the gateways to which the device with num_id 456 is bound. (optional)</param>
        /// <param name="gatewayListOptionsAssociationsGatewayId">If set, only devices associated with the specified gateway are returned. The gateway ID can be numeric (num_id) or the user-defined string (id). For example, if 123 is specified, only devices bound to the gateway with num_id 123 are returned (optional)</param>
        /// <param name="gatewayListOptionsGatewayType">If GATEWAY is specified, only gateways are returned. If NON_GATEWAY is specified, only non-gateway devices are returned. If GATEWAY_TYPE_UNSPECIFIED is specified, all devices are returned. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ListDevicesOnlineResponse</returns>
        ListDevicesOnlineResponse GetSubscriptionDevices(string subscriptionId, int? pageNumber = default(int?), int? pageSize = default(int?), string fieldMask = default(string), bool? sortByClientOnline = default(bool?), List<string> deviceIds = default(List<string>), List<string> deviceNumIds = default(List<string>), string gatewayListOptionsAssociationsDeviceId = default(string), string gatewayListOptionsAssociationsGatewayId = default(string), string gatewayListOptionsGatewayType = default(string), int operationIndex = 0);
        ...
        /// <param name="gatewayListOptionsGatewayType">If GATEWAY is specified, only gateways are returned. If NON_GATEWAY is specified, only non-gateway devices are returned. If GATEWAY_TYPE_UNSPECIFIED is specified, all devices are returned. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ListDevicesOnlineResponse</returns>
        ApiResponse<ListDevicesOnlineResponse> GetSubscriptionDevicesWithHttpInfo(string subscriptionId, int? pageNumber = default(int?), int? pageSize = default(int?), string fieldMask = default(string), bool? sortByClientOnline = default(bool?), List<string> deviceIds = default(List<string>), List<string> deviceNumIds = default(List<string>), string gatewayListOptionsAssociationsDeviceId = default(string), string gatewayListOptionsAssociationsGatewayId = default(string), string gatewayListOptionsGatewayType = default(string), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public interface IDeviceApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ListDevicesOnlineResponse</returns>
        System.Threading.Tasks.Task<ListDevicesOnlineResponse> GetSubscriptionDevicesAsync(string subscriptionId, int? pageNumber = default(int?), int? pageSize = default(int?), string fieldMask = default(string), bool? sortByClientOnline = default(bool?), List<string> deviceIds = default(List<string>), List<string> deviceNumIds = default(List<string>), string gatewayListOptionsAssociationsDeviceId = default(string), string gatewayListOptionsAssociationsGatewayId = default(string), string gatewayListOptionsGatewayType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListDevicesOnlineResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ListDevicesOnlineResponse>> GetSubscriptionDevicesWithHttpInfoAsync(string subscriptionId, int? pageNumber = default(int?), int? pageSize = default(int?), string fieldMask = default(string), bool? sortByClientOnline = default(bool?), List<string> deviceIds = default(List<string>), List<string> deviceNumIds = default(List<string>), string gatewayListOptionsAssociationsDeviceId = default(string), string gatewayListOptionsAssociationsGatewayId = default(string), string gatewayListOptionsGatewayType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class DeviceApi : IDeviceApi
    {
        ...
        public OmniCore.Client.ApiResponse<Info> BindDeviceWithHttpInfo(string subscriptionId, string registryId, BindRequest bind, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Post<Info>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/bindDeviceToGateway", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<Info>> BindDeviceWithHttpInfoAsync(string subscriptionId, string registryId, BindRequest bind, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Info>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/bindDeviceToGateway", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<Info> BindDevicesWithHttpInfo(string subscriptionId, string registryId, BindRequestIdsGateway bind, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Info>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/bindDevicesToGateway", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<Info>> BindDevicesWithHttpInfoAsync(string subscriptionId, string registryId, BindRequestIdsGateway bind, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Info>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/bindDevicesToGateway", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<Object> BlockDeviceCommuncationWithHttpInfo(string subscriptionid, string registryId, string deviceId, BlockCommunicationBody block, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Object>("/omnicore/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/communication", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<Object>> BlockDeviceCommuncationWithHttpInfoAsync(string subscriptionid, string registryId, string deviceId, BlockCommunicationBody block, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/omnicore/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/communication", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<Device> CreateDeviceWithHttpInfo(string subscriptionId, string registryId, Device device, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Device>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/devices", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<Device>> CreateDeviceWithHttpInfoAsync(string subscriptionId, string registryId, Device device, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Device>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/devices", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<Object> DeleteDeviceWithHttpInfo(string subscriptionId, string registryId, string deviceId, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<Object>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/devices/{deviceId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<Object>> DeleteDeviceWithHttpInfoAsync(string subscriptionId, string registryId, string deviceId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/devices/{deviceId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<ListDeviceConfigVersionsResponse> GetConfigWithHttpInfo(string subscriptionid, string registryId, string deviceId, int? numVersions = default(int?), int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ListDeviceConfigVersionsResponse>("/omnicore/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/configVersions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<ListDeviceConfigVersionsResponse>> GetConfigWithHttpInfoAsync(string subscriptionid, string registryId, string deviceId, int? numVersions = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ListDeviceConfigVersionsResponse>("/omnicore/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/configVersions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<Device> GetDeviceWithHttpInfo(string subscriptionId, string registryId, string deviceId, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Device>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/devices/{deviceId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<Device>> GetDeviceWithHttpInfoAsync(string subscriptionId, string registryId, string deviceId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Device>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/devices/{deviceId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<ListDevicesResponse> GetDevicesWithHttpInfo(string subscriptionId, string registryId, int? pageNumber = default(int?), int? pageSize = default(int?), string fieldMask = default(string), List<string> deviceIds = default(List<string>), List<string> deviceNumIds = default(List<string>), string gatewayListOptionsAssociationsDeviceId = default(string), string gatewayListOptionsAssociationsGatewayId = default(string), string gatewayListOptionsGatewayType = default(string), int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ListDevicesResponse>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/devices", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<ListDevicesResponse>> GetDevicesWithHttpInfoAsync(string subscriptionId, string registryId, int? pageNumber = default(int?), int? pageSize = default(int?), string fieldMask = default(string), List<string> deviceIds = default(List<string>), List<string> deviceNumIds = default(List<string>), string gatewayListOptionsAssociationsDeviceId = default(string), string gatewayListOptionsAssociationsGatewayId = default(string), string gatewayListOptionsGatewayType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ListDevicesResponse>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/devices", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<ListDeviceStatesResponse> GetStatesWithHttpInfo(string subscriptionid, string registryId, string deviceId, int? numStates = default(int?), int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ListDeviceStatesResponse>("/omnicore/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/states", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<ListDeviceStatesResponse>> GetStatesWithHttpInfoAsync(string subscriptionid, string registryId, string deviceId, int? numStates = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ListDeviceStatesResponse>("/omnicore/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/states", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ListDevicesOnlineResponse</returns>
        public ListDevicesOnlineResponse GetSubscriptionDevices(string subscriptionId, int? pageNumber = default(int?), int? pageSize = default(int?), string fieldMask = default(string), bool? sortByClientOnline = default(bool?), List<string> deviceIds = default(List<string>), List<string> deviceNumIds = default(List<string>), string gatewayListOptionsAssociationsDeviceId = default(string), string gatewayListOptionsAssociationsGatewayId = default(string), string gatewayListOptionsGatewayType = default(string), int operationIndex = 0)
        {
            OmniCore.Client.ApiResponse<ListDevicesOnlineResponse> localVarResponse = GetSubscriptionDevicesWithHttpInfo(subscriptionId, pageNumber, pageSize, fieldMask, sortByClientOnline, deviceIds, deviceNumIds, gatewayListOptionsAssociationsDeviceId, gatewayListOptionsAssociationsGatewayId, gatewayListOptionsGatewayType);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ListDevicesOnlineResponse</returns>
        public OmniCore.Client.ApiResponse<ListDevicesOnlineResponse> GetSubscriptionDevicesWithHttpInfo(string subscriptionId, int? pageNumber = default(int?), int? pageSize = default(int?), string fieldMask = default(string), bool? sortByClientOnline = default(bool?), List<string> deviceIds = default(List<string>), List<string> deviceNumIds = default(List<string>), string gatewayListOptionsAssociationsDeviceId = default(string), string gatewayListOptionsAssociationsGatewayId = default(string), string gatewayListOptionsGatewayType = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'subscriptionId' is set
            if (subscriptionId == null)
            {
                throw new OmniCore.Client.ApiException(400, "Missing required parameter 'subscriptionId' when calling DeviceApi->GetSubscriptionDevices");
            }
            ...
            if (sortByClientOnline != null)
            {
                localVarRequestOptions.QueryParameters.Add(OmniCore.Client.ClientUtils.ParameterToMultiMap("", "sortByClientOnline", sortByClientOnline));
            }
            if (deviceIds != null)
            {
                localVarRequestOptions.QueryParameters.Add(OmniCore.Client.ClientUtils.ParameterToMultiMap("csv", "deviceIds", deviceIds));
            ...
            localVarRequestOptions.Operation = "DeviceApi.GetSubscriptionDevices";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ListDevicesOnlineResponse>("/omnicore/subscriptions/{subscriptionId}/devices", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetSubscriptionDevices", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ListDevicesOnlineResponse</returns>
        public async System.Threading.Tasks.Task<ListDevicesOnlineResponse> GetSubscriptionDevicesAsync(string subscriptionId, int? pageNumber = default(int?), int? pageSize = default(int?), string fieldMask = default(string), bool? sortByClientOnline = default(bool?), List<string> deviceIds = default(List<string>), List<string> deviceNumIds = default(List<string>), string gatewayListOptionsAssociationsDeviceId = default(string), string gatewayListOptionsAssociationsGatewayId = default(string), string gatewayListOptionsGatewayType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            OmniCore.Client.ApiResponse<ListDevicesOnlineResponse> localVarResponse = await GetSubscriptionDevicesWithHttpInfoAsync(subscriptionId, pageNumber, pageSize, fieldMask, sortByClientOnline, deviceIds, deviceNumIds, gatewayListOptionsAssociationsDeviceId, gatewayListOptionsAssociationsGatewayId, gatewayListOptionsGatewayType, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListDevicesOnlineResponse)</returns>
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<ListDevicesOnlineResponse>> GetSubscriptionDevicesWithHttpInfoAsync(string subscriptionId, int? pageNumber = default(int?), int? pageSize = default(int?), string fieldMask = default(string), bool? sortByClientOnline = default(bool?), List<string> deviceIds = default(List<string>), List<string> deviceNumIds = default(List<string>), string gatewayListOptionsAssociationsDeviceId = default(string), string gatewayListOptionsAssociationsGatewayId = default(string), string gatewayListOptionsGatewayType = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'subscriptionId' is set
            if (subscriptionId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ListDevicesOnlineResponse>("/omnicore/subscriptions/{subscriptionId}/devices", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<Object> SendCommandToDeviceWithHttpInfo(string subscriptionid, string registryId, string deviceId, DeviceCommand command, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/omnicore/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/sendCommandToDevice", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<Object>> SendCommandToDeviceWithHttpInfoAsync(string subscriptionid, string registryId, string deviceId, DeviceCommand command, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/omnicore/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/sendCommandToDevice", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<Info> UnBindDeviceWithHttpInfo(string subscriptionId, string registryId, BindRequest unbind, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Info>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/unbindDeviceFromGateway", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<Info>> UnBindDeviceWithHttpInfoAsync(string subscriptionId, string registryId, BindRequest unbind, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Info>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/unbindDeviceFromGateway", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<Info> UnBindDevicesWithHttpInfo(string subscriptionId, string registryId, BindRequestIdsGateway unbind, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Info>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/unbindDevicesFromGateway", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<Info>> UnBindDevicesWithHttpInfoAsync(string subscriptionId, string registryId, BindRequestIdsGateway unbind, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Info>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/unbindDevicesFromGateway", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<DeviceConfig> UpdateConfigurationToDeviceWithHttpInfo(string subscriptionid, string registryId, string deviceId, DeviceConfiguration configuration, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<DeviceConfig>("/omnicore/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/updateConfigurationToDevice", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<DeviceConfig>> UpdateConfigurationToDeviceWithHttpInfoAsync(string subscriptionid, string registryId, string deviceId, DeviceConfiguration configuration, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<DeviceConfig>("/omnicore/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/updateConfigurationToDevice", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<Info> UpdateCustomOnboardRequestWithHttpInfo(string subscriptionid, string registryId, string deviceId, CustomOnboard customOnboard, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Info>("/omnicore/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/updateCustomOnboardRequest", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<Info>> UpdateCustomOnboardRequestWithHttpInfoAsync(string subscriptionid, string registryId, string deviceId, CustomOnboard customOnboard, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Info>("/omnicore/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/updateCustomOnboardRequest", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<Device> UpdateDeviceWithHttpInfo(string subscriptionId, string registryId, string deviceId, string updateMask, Device device, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Patch<Device>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/devices/{deviceId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<Device>> UpdateDeviceWithHttpInfoAsync(string subscriptionId, string registryId, string deviceId, string updateMask, Device device, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PatchAsync<Device>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}/devices/{deviceId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
