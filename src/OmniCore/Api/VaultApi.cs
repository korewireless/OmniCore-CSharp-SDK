...
namespace OmniCore.Api
{
    ...
    public interface IVaultApiSync : IApiAccessor
    {
        ...
        /// <exception cref="OmniCore.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="subscriptionid">Subscription ID</param>
        /// <param name="enableVault">application/json (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Details</returns>
        Details EnableVault(string subscriptionid, EnableVault enableVault = default(EnableVault), int operationIndex = 0);
        ...
        /// <param name="enableVault">application/json (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Details</returns>
        ApiResponse<Details> EnableVaultWithHttpInfo(string subscriptionid, EnableVault enableVault = default(EnableVault), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public interface IVaultApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Details</returns>
        System.Threading.Tasks.Task<Details> EnableVaultAsync(string subscriptionid, EnableVault enableVault = default(EnableVault), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Details)</returns>
        System.Threading.Tasks.Task<ApiResponse<Details>> EnableVaultWithHttpInfoAsync(string subscriptionid, EnableVault enableVault = default(EnableVault), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class VaultApi : IVaultApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Details</returns>
        public Details EnableVault(string subscriptionid, EnableVault enableVault = default(EnableVault), int operationIndex = 0)
        {
            OmniCore.Client.ApiResponse<Details> localVarResponse = EnableVaultWithHttpInfo(subscriptionid, enableVault);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Details</returns>
        public OmniCore.Client.ApiResponse<Details> EnableVaultWithHttpInfo(string subscriptionid, EnableVault enableVault = default(EnableVault), int operationIndex = 0)
        {
            // verify the required parameter 'subscriptionid' is set
            if (subscriptionid == null)
            {
                throw new OmniCore.Client.ApiException(400, "Missing required parameter 'subscriptionid' when calling VaultApi->EnableVault");
            }
            ...
            localVarRequestOptions.PathParameters.Add("subscriptionid", OmniCore.Client.ClientUtils.ParameterToString(subscriptionid)); // path parameter
            localVarRequestOptions.Data = enableVault;

            localVarRequestOptions.Operation = "VaultApi.EnableVault";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Details>("/vault/subscriptions/{subscriptionid}/enable-vault", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("EnableVault", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Details</returns>
        public async System.Threading.Tasks.Task<Details> EnableVaultAsync(string subscriptionid, EnableVault enableVault = default(EnableVault), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            OmniCore.Client.ApiResponse<Details> localVarResponse = await EnableVaultWithHttpInfoAsync(subscriptionid, enableVault, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Details)</returns>
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<Details>> EnableVaultWithHttpInfoAsync(string subscriptionid, EnableVault enableVault = default(EnableVault), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'subscriptionid' is set
            if (subscriptionid == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Details>("/vault/subscriptions/{subscriptionid}/enable-vault", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
