...
namespace OmniCore.Api
{
    ...
    public partial class RegistryApi : IRegistryApi
    {
        ...
        public OmniCore.Client.ApiResponse<DeviceRegistry> CreateRegistryWithHttpInfo(string subscriptionId, DeviceRegistry registry = default(DeviceRegistry), int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Post<DeviceRegistry>("/omnicore/subscriptions/{subscriptionId}/registries", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<DeviceRegistry>> CreateRegistryWithHttpInfoAsync(string subscriptionId, DeviceRegistry registry = default(DeviceRegistry), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<DeviceRegistry>("/omnicore/subscriptions/{subscriptionId}/registries", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<Info> DeleteRegistryWithHttpInfo(string subscriptionId, string registryId, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<Info>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<Info>> DeleteRegistryWithHttpInfoAsync(string subscriptionId, string registryId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Info>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<ListDeviceRegistries> GetRegistriesWithHttpInfo(string subscriptionId, int? pageNumber = default(int?), int? pageSize = default(int?), List<string> registryIds = default(List<string>), int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ListDeviceRegistries>("/omnicore/subscriptions/{subscriptionId}/registries", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<ListDeviceRegistries>> GetRegistriesWithHttpInfoAsync(string subscriptionId, int? pageNumber = default(int?), int? pageSize = default(int?), List<string> registryIds = default(List<string>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ListDeviceRegistries>("/omnicore/subscriptions/{subscriptionId}/registries", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<DeviceRegistry> GetRegistryWithHttpInfo(string subscriptionId, string registryId, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<DeviceRegistry>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<DeviceRegistry>> GetRegistryWithHttpInfoAsync(string subscriptionId, string registryId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<DeviceRegistry>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<Object> SendBroadcastToDevicesWithHttpInfo(string subscriptionid, string registryId, DeviceCommand broadcast, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/omnicore/subscriptions/{subscriptionid}/registries/{registryId}/sendBroadcastToDevice", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<Object>> SendBroadcastToDevicesWithHttpInfoAsync(string subscriptionid, string registryId, DeviceCommand broadcast, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/omnicore/subscriptions/{subscriptionid}/registries/{registryId}/sendBroadcastToDevice", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public OmniCore.Client.ApiResponse<DeviceRegistry> UpdateRegistryWithHttpInfo(string subscriptionId, string registryId, string updateMask, DeviceRegistry registry = default(DeviceRegistry), int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Patch<DeviceRegistry>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<OmniCore.Client.ApiResponse<DeviceRegistry>> UpdateRegistryWithHttpInfoAsync(string subscriptionId, string registryId, string updateMask, DeviceRegistry registry = default(DeviceRegistry), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PatchAsync<DeviceRegistry>("/omnicore/subscriptions/{subscriptionId}/registries/{registryId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
