...
namespace OmniCore.Test.Api
{
    ...
    public class VaultApiTests : IDisposable
    {
        ...
        public void EnableEncryptionTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string subscriptionid = null;
            //EnableEncryptionBody enableEncryptionBody = null;
            //var response = instance.EnableEncryption(subscriptionid, enableEncryptionBody);
            //Assert.IsType<Frame>(response);
        }
        ...
        /// </summary>
        [Fact]
        public void SetRetentionTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string subscriptionid = null;
            //SetRetentionBody setRetentionBody = null;
            //var response = instance.SetRetention(subscriptionid, setRetentionBody);
            //Assert.IsType<Frame>(response);
        }
